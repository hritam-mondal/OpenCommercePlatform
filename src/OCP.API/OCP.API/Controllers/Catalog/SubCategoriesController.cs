...
[ApiController]
[Authorize]
public class SubCategoriesController(ISubCategoriesService service) : ControllerBase
{
    [HttpGet]
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CreateSubCategoryDto dto, CancellationToken ct)
    {
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> Update(int id, [FromBody] UpdateSubCategoryDto dto, CancellationToken ct)
    {
